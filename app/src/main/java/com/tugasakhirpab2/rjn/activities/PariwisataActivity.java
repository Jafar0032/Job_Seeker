...
public class PariwisataActivity extends AppCompatActivity {
    ...
    private ActivityPariwisataBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getDataFromAPI();
                hideKeyboard(PariwisataActivity.this);
            }
        });
    }
    ...
    private void setupRecyclerViewKerja() {
        kerjaAdapter = new KerjaAdapter(results, new KerjaAdapter.OnAdapterListener() {
            ...
            public void onClick(KerjaModel.Result result) {
                Intent intent = new Intent(PariwisataActivity.this, DetailKerjaActivity.class);
    ...
    {
        APIService.apiEndpoint().getKategoriHotelPariwisata(searchContent)
