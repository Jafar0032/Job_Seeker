...
import com.tugasakhirpab2.rjn.databinding.ActivityHukumBinding;
import com.tugasakhirpab2.rjn.databinding.ActivityPariwisataBinding;
...
public class HukumActivity extends AppCompatActivity {
    ...
    private ActivityHukumBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityHukumBinding.inflate(getLayoutInflater());
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getDataFromAPI();
                hideKeyboard(HukumActivity.this);
            }
        });
    }
    ...
    private void setupRecyclerViewKerja() {
        kerjaAdapter = new KerjaAdapter(results, new KerjaAdapter.OnAdapterListener() {
            ...
            public void onClick(KerjaModel.Result result) {
                Intent intent = new Intent(HukumActivity.this, DetailKerjaActivity.class);
    ...
    {
        showProgressBar();
        APIService.apiEndpoint().getKategoriHukum(searchContent)
