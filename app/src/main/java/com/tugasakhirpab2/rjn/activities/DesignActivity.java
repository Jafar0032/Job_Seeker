...
import com.tugasakhirpab2.rjn.databinding.ActivityDesignBinding;
...
public class DesignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                getDataFromAPI();
                hideKeyboard(DesignActivity.this);
            }
        });
    }
    ...
    private void setupRecyclerViewKerja() {
        kerjaAdapter = new KerjaAdapter(results, new KerjaAdapter.OnAdapterListener() {
            ...
            public void onClick(KerjaModel.Result result) {
                Intent intent = new Intent(DesignActivity.this, DetailKerjaActivity.class);
    ...
    {
        showProgressBar();
        APIService.apiEndpoint().getKategoriDesignCreative(searchContent)
